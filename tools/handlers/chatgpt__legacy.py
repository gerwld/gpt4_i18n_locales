...
from exceptions import NotEnoughInformationException, CouldNotSolveCaptcha
...
try:
    ...
    print(f"Error during ChromeDriver update: {e}")
...
class GptHandler:
    ...
    continue2_xq = '/html/body/div[1]/main/section/div/div/div/form/div[3]/button'
    ...
    def __login(self, username: str, password: str) -> None:
        ...
        # is_checked = reCaptchaV3(self.browser)  # it returns bool
        # if not is_checked:
        ...
        # Click continue
        time.sleep(1)
        continue_button = self.__sleepy_find_element(By.XPATH, self.continue2_xq)
        continue_button.click()
        time.sleep(1)
